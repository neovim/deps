local site_config = {}
site_config.LUAROCKS_PREFIX=[[/opt/neovim-deps/64/usr]]
site_config.LUA_INCDIR=[[/opt/neovim-deps/64/usr/include/luajit-2.0]]
site_config.LUA_LIBDIR=[[/opt/neovim-deps/64/usr/lib]]
site_config.LUA_BINDIR=[[/opt/neovim-deps/64/usr/bin]]
site_config.LUA_INTERPRETER=[[luajit]]
site_config.LUAROCKS_SYSCONFDIR=[[/opt/neovim-deps/64/usr/etc/luarocks]]
site_config.LUAROCKS_ROCKS_TREE=[[/opt/neovim-deps/64/usr]]
