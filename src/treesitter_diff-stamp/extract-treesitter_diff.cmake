...
#
get_filename_component(filename "/home/runner/work/deps/deps/neovim/deps/build/downloads/treesitter_diff/v0.1.0.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/deps/deps/neovim/deps/build/src/treesitter_diff" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-treesitter_diff${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-treesitter_diff${i}")
